...
func TestMigrations(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			table: "properties",
			cols:  []string{"id", "address", "mpr_id", "realtor_url", "price", "bedrooms", "bathrooms", "sqft", "lot_size", "year_built", "property_type", "status", "rating", "raw_json", "created_at", "updated_at", "visited"},
		},
		{
